...
void
LrWpanMacHeader::SetSrcAddrFields(uint16_t panId, Mac64Address addr)
{
    m_addrSrcPanId = panId;
...
void
LrWpanMacHeader::SetDstAddrFields(uint16_t panId, Mac16Address addr)
{
...
void
LrWpanMacHeader::SetDstAddrFields(uint16_t panId, Mac64Address addr)
{
    m_addrDstPanId = panId;
...
void
LrWpanMacHeader::SetKeyId(uint32_t keySrc, uint8_t keyIndex)
{
    m_auxKeyIdKeyIndex = keyIndex;
...
void
LrWpanMacHeader::SetKeyId(uint64_t keySrc, uint8_t keyIndex)
{
    m_auxKeyIdKeyIndex = keyIndex;
