...
int main (int argc, char *argv[])
{
  ...
  Ptr<ConstantPositionMobilityModel> PanCoordinatorN0Mobility = CreateObject<ConstantPositionMobilityModel> ();
  PanCoordinatorN0Mobility->SetPosition (Vector (0,0,0));
  dev0->GetPhy ()->SetMobility (PanCoordinatorN0Mobility);

  Ptr<ConstantPositionMobilityModel> endDeviceN1Mobility = CreateObject<ConstantPositionMobilityModel> ();
  endDeviceN1Mobility->SetPosition (Vector (10,0,0));
  dev1->GetPhy ()->SetMobility (endDeviceN1Mobility);

  Ptr<ConstantPositionMobilityModel> PanCoordinatorN2Mobility = CreateObject<ConstantPositionMobilityModel> ();
