...
RedQueueDiscTestCase::RunRedTest(QueueSizeUnit mode)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(st.GetNDroppedPackets(RedQueueDisc::FORCED_DROP),
                          0,
    ...
    NS_TEST_ASSERT_MSG_EQ(
        ...
        true,
        "Verify that we can actually set the attribute MaxSize");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("QW", DoubleValue(0.020)),
                          true,
                          "Verify that we can actually set the attribute QW");
    queue->Initialize();
    Enqueue(queue, pktSize, 300, false);
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("QW", DoubleValue(0.020)),
                          true,
                          "Verify that we can actually set the attribute QW");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("LInterm", DoubleValue(5)),
                          true,
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("QW", DoubleValue(0.020)),
                          true,
                          "Verify that we can actually set the attribute QW");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("Gentle", BooleanValue(false)),
                          true,
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("QW", DoubleValue(0.020)),
                          true,
                          "Verify that we can actually set the attribute QW");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("Wait", BooleanValue(false)),
                          true,
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("LInterm", DoubleValue(2)),
                          true,
                          "Verify that we can actually set the attribute LInterm");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("Gentle", BooleanValue(true)),
                          true,
                          "Verify that we can actually set the attribute Gentle");
    ...
    NS_TEST_ASSERT_MSG_EQ(st.GetNMarkedPackets(RedQueueDisc::UNFORCED_MARK),
                          0,
    ...
    Enqueue(queue, pktSize, 300, true);
    st = queue->GetStats();
    // Packets are ECN capable, RED queue disc is ECN enabled; there should be only unforced marks,
    // no unforced drops
    NS_TEST_ASSERT_MSG_EQ(st.GetNDroppedPackets(RedQueueDisc::UNFORCED_DROP),
                          0,
                          "There should be no unforced drops");
    NS_TEST_ASSERT_MSG_NE(st.GetNMarkedPackets(RedQueueDisc::UNFORCED_MARK),
                          0,
    ...
    NS_TEST_ASSERT_MSG_NE(drop.test11,
                          0,
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("Gentle", BooleanValue(true)),
                          true,
                          "Verify that we can actually set the attribute Gentle");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("FengAdaptive", BooleanValue(true)),
                          true,
    ...
    NS_TEST_ASSERT_MSG_LT(drop.test12,
                          drop.test11,
    ...
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("Gentle", BooleanValue(true)),
                          true,
                          "Verify that we can actually set the attribute Gentle");
    NS_TEST_ASSERT_MSG_EQ(queue->SetAttributeFailSafe("NLRED", BooleanValue(true)),
                          true,
    ...
    NS_TEST_ASSERT_MSG_LT(drop.test13,
                          drop.test11,
                          "Test 13 should have less drops due to probability mark than test 11");
}

void
RedQueueDiscTestCase::Enqueue(Ptr<RedQueueDisc> queue,
                              uint32_t size,
                              uint32_t nPkt,
                              bool ecnCapable)
{
