...
def register_types(module):
    ...
    module.add_container('std::map< std::basic_string< char >, unsigned long long, std::less< void >, std::allocator< std::pair< std::basic_string< char > const, unsigned long long > > >', ('std::basic_string< char, std::char_traits< char >, std::allocator< char > >', 'long unsigned int'), container_type='map')
