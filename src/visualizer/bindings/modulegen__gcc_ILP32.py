...
def register_types(module):
    ...
    module.add_class('RxPacketSample', outer_class=root_module['ns3::PyViz'], parent=root_module['ns3::PyViz::PacketSample'])
    ...
    module.add_class('TxPacketSample', outer_class=root_module['ns3::PyViz'], parent=root_module['ns3::PyViz::PacketSample'])
