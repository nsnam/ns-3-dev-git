...
def register_types(module):
    ...
    module.add_container('std::map< std::string, std::string >', ('std::basic_string< char, std::char_traits< char >, std::allocator< char > >', 'std::basic_string< char, std::char_traits< char >, std::allocator< char > >'), container_type='map')
