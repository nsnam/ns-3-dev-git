...
main(int argc, char* argv[])
{
    ...
    case 1:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{20});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5180});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 2:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{22});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{2412});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 3:
    ...
    case 6:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{80});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5210});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 7:
    ...
    case 9:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{80});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5985});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 10:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{10});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5860});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 11:
        wifi.SetStandard(WIFI_STANDARD_80211p);
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{5});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5860});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 12:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{20});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5220});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 13:
        wifi.SetStandard(WIFI_STANDARD_80211n);
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{20});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5200});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 14:
        wifi.SetStandard(WIFI_STANDARD_80211n);
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{40});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5230});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 15:
    ...
    case 17:
        ...
        NS_ASSERT(phySta->GetChannelWidth() == MHz_t{20});
        NS_ASSERT(phySta->GetFrequency() == MHz_t{5500});
        PrintAttributesIfEnabled(printAttributes);
        break;
    case 18:
