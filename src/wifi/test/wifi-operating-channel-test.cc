...
SetWifiOperatingChannelTest::DoRun()
{
    ...
    RunOne("default 20 MHz OFDM channel operating on channel 36",
           {{36, MHz_t{0}, MHz_t{20}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    RunOne("default 40 MHz OFDM channel operating on channel 38",
           {{38, MHz_t{0}, MHz_t{40}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    RunOne("default 80 MHz OFDM channel operating on channel 42",
           {{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    RunOne("default 160 MHz (contiguous) OFDM channel operating on channel 50",
           {{50, MHz_t{0}, MHz_t{160}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    RunOne("valid 80+80 MHz (non-contiguous) OFDM channel operating on channels 42 and 106",
           {{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {106, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    RunOne("invalid 80+80 MHz (non-contiguous) OFDM channel higher channel not being 80 MHz",
           {{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {102, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           true);
    ...
    RunOne("invalid 80+80 MHz (non-contiguous) OFDM channel with segments configured to be "
           ...
           {{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {58, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           true);
    ...
    RunOne("invalid 80+80 MHz (non-contiguous) OFDM channel with each segments configured on a "
           "different band",
           {{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {215, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_6GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           true);

    RunOne("default 320 MHz OFDM channel operating on channel 31",
           {{31, MHz_t{0}, MHz_t{320}, WIFI_PHY_BAND_6GHZ}},
           WIFI_STANDARD_UNSPECIFIED,
           WIFI_PHY_BAND_UNSPECIFIED,
           false,
    ...
    uint8_t expectedP20Index)
{
    ...
    NS_TEST_ASSERT_MSG_EQ(m_phy->GetOperatingChannel().GetPrimaryChannelIndex(MHz_t{20}),
                          expectedP20Index,
...
PhyChannelSettingsToOperatingChannelTest::DoRun()
{
    ...
    RunOne("{0, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_80MHZ,
           {{42, MHz_t{5210}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           0);
    ...
    RunOne("{0, 0, BAND_UNSPECIFIED, 0};{0, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_80_PLUS_80MHZ,
           {{42, MHz_t{5210}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {106, MHz_t{5530}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           0);
    ...
    RunOne("{106, 0, BAND_UNSPECIFIED, 0};{0, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_80_PLUS_80MHZ,
           {{106, MHz_t{5530}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
            {138, MHz_t{5690}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
           0);

    // Test unique channel 36 (20 MHz)
    RunOne("{36, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_20MHZ,
           {{36, MHz_t{5180}, MHz_t{20}, WIFI_PHY_BAND_5GHZ}},
           0);

    // Test unique channel 38 (40 MHz)
    RunOne("{38, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_40MHZ,
           {{38, MHz_t{5190}, MHz_t{40}, WIFI_PHY_BAND_5GHZ}},
           0);
    ...
    RunOne("{50, 0, BAND_UNSPECIFIED, 0}",
           WifiChannelWidthType::CW_160MHZ,
           {{50, MHz_t{5250}, MHz_t{160}, WIFI_PHY_BAND_5GHZ}},
           0);
    ...
    RunOne("{31, 0, BAND_6GHZ, 0}",
           WifiChannelWidthType::CW_320MHZ,
           {{31, MHz_t{6105}, MHz_t{320}, WIFI_PHY_BAND_6GHZ}},
           0);
...
Ptr<HePpdu>
WifiPhyChannel80Plus80Test::CreateDummyHePpdu(MHz_t bandwidth,
...
WifiPhyChannel80Plus80Test::DoRun()
{
    ...
    {
        m_channel.Set({{42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
                       {106, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
                      WIFI_STANDARD_UNSPECIFIED);
        m_channel.SetPrimary20Index(3);

        const auto indexPrimary160Mhz = m_channel.GetPrimaryChannelIndex(MHz_t{160});
        NS_TEST_ASSERT_MSG_EQ(indexPrimary160Mhz, 0, "Primary 160 MHz channel shall have index 0");
        const auto indexPrimary80Mhz = m_channel.GetPrimaryChannelIndex(MHz_t{80});
        NS_TEST_ASSERT_MSG_EQ(indexPrimary80Mhz, 0, "Primary 80 MHz channel shall have index 0");
        const auto indexPrimary40Mhz = m_channel.GetPrimaryChannelIndex(MHz_t{40});
        NS_TEST_ASSERT_MSG_EQ(indexPrimary40Mhz, 1, "Primary 40 MHz channel shall have index 1");
        const auto indexPrimary20Mhz = m_channel.GetPrimaryChannelIndex(MHz_t{20});
        NS_TEST_ASSERT_MSG_EQ(indexPrimary20Mhz, 3, "Primary 20 MHz channel shall have index 3");

        const auto indexSecondary80Mhz = m_channel.GetSecondaryChannelIndex(MHz_t{80});
        NS_TEST_ASSERT_MSG_EQ(indexSecondary80Mhz,
                              1,
                              "Secondary 80 MHz channel shall have index 1");
        const auto indexSecondary40Mhz = m_channel.GetSecondaryChannelIndex(MHz_t{40});
        NS_TEST_ASSERT_MSG_EQ(indexSecondary40Mhz,
                              0,
                              "Secondary 40 MHz channel shall have index 0");
        const auto indexSecondary20Mhz = m_channel.GetSecondaryChannelIndex(MHz_t{20});
        ...
        const auto primary80MhzCenterFrequency =
            m_channel.GetPrimaryChannelCenterFrequency(MHz_t{80});
        ...
        const auto primary40MhzCenterFrequency =
            m_channel.GetPrimaryChannelCenterFrequency(MHz_t{40});
        ...
        const auto primary20MhzCenterFrequency =
            m_channel.GetPrimaryChannelCenterFrequency(MHz_t{20});
        ...
        const auto secondary80MhzCenterFrequency =
            m_channel.GetSecondaryChannelCenterFrequency(MHz_t{80});
        ...
        const auto secondary40MhzCenterFrequency =
            m_channel.GetSecondaryChannelCenterFrequency(MHz_t{40});
        ...
        const auto secondary20MhzCenterFrequency =
            m_channel.GetSecondaryChannelCenterFrequency(MHz_t{20});
        ...
        const auto primary80MhzChannelNumber =
            m_channel.GetPrimaryChannelNumber(MHz_t{80}, WIFI_STANDARD_80211ax);
        ...
        const auto primary40MhzChannelNumber =
            m_channel.GetPrimaryChannelNumber(MHz_t{40}, WIFI_STANDARD_80211ax);
        ...
        const auto primary20MhzChannelNumber =
            m_channel.GetPrimaryChannelNumber(MHz_t{20}, WIFI_STANDARD_80211ax);
        NS_TEST_ASSERT_MSG_EQ(primary20MhzChannelNumber,
                              48,
                              "Primary 20 MHz channel number shall be 48");

        auto ppdu160MHz = CreateDummyHePpdu(MHz_t{160}, m_channel);
        ...
        auto ppdu80MHz = CreateDummyHePpdu(MHz_t{80}, m_channel);
        ...
        auto ppdu40MHz = CreateDummyHePpdu(MHz_t{40}, m_channel);
        ...
        auto ppdu20MHz = CreateDummyHePpdu(MHz_t{20}, m_channel);
    ...
    {
        m_channel.Set({{106, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ},
                       {42, MHz_t{0}, MHz_t{80}, WIFI_PHY_BAND_5GHZ}},
                      WIFI_STANDARD_UNSPECIFIED);
        m_channel.SetPrimary20Index(3);
