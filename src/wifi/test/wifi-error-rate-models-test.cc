...
std::map<std::pair<uint8_t /* mcs */, uint32_t /* size */>,
         std::map<dB_t /* snr */, double /* per */>>
    expectedTableValues = {
        /* MCS 0 - 1458 bytes */
        {std::make_pair(0, 1458),
         {
             {dB_t{-4.00}, 1.00000}, {dB_t{-3.75}, 1.00000}, {dB_t{-3.50}, 1.00000},
             {dB_t{-3.25}, 1.00000}, {dB_t{-3.00}, 1.00000}, {dB_t{-2.75}, 1.00000},
             {dB_t{-2.50}, 1.00000}, {dB_t{-2.25}, 1.00000}, {dB_t{-2.00}, 1.00000},
             {dB_t{-1.75}, 1.00000}, {dB_t{-1.50}, 1.00000}, {dB_t{-1.25}, 1.00000},
             {dB_t{-1.00}, 1.00000}, {dB_t{-0.75}, 0.99700}, {dB_t{-0.50}, 0.99400},
             {dB_t{-0.25}, 0.90625}, {dB_t{0.00}, 0.81850},  {dB_t{0.25}, 0.55465},
             {dB_t{0.50}, 0.29080},  {dB_t{0.75}, 0.17855},  {dB_t{1.00}, 0.06630},
             {dB_t{1.25}, 0.03875},  {dB_t{1.50}, 0.01120},  {dB_t{1.75}, 0.00635},
             {dB_t{2.00}, 0.00150},  {dB_t{2.25}, 0.00083},  {dB_t{2.50}, 0.00015},
             {dB_t{2.75}, 0.00008},  {dB_t{3.00}, 0.00001},  {dB_t{3.25}, 0.00000},
             {dB_t{3.50}, 0.00000},  {dB_t{3.75}, 0.00000},  {dB_t{4.00}, 0.00000},
             {dB_t{4.25}, 0.00000},  {dB_t{4.50}, 0.00000},  {dB_t{4.75}, 0.00000},
             {dB_t{5.00}, 0.00000},  {dB_t{5.25}, 0.00000},  {dB_t{5.50}, 0.00000},
             {dB_t{5.75}, 0.00000},  {dB_t{6.00}, 0.00000},  {dB_t{6.25}, 0.00000},
             {dB_t{6.50}, 0.00000},  {dB_t{6.75}, 0.00000},  {dB_t{7.00}, 0.00000},
             {dB_t{7.25}, 0.00000},  {dB_t{7.50}, 0.00000},  {dB_t{7.75}, 0.00000},
             {dB_t{8.00}, 0.00000},  {dB_t{8.25}, 0.00000},  {dB_t{8.50}, 0.00000},
             {dB_t{8.75}, 0.00000},  {dB_t{9.00}, 0.00000},  {dB_t{9.25}, 0.00000},
             {dB_t{9.50}, 0.00000},  {dB_t{9.75}, 0.00000},  {dB_t{10.00}, 0.00000},
             {dB_t{10.25}, 0.00000}, {dB_t{10.50}, 0.00000}, {dB_t{10.75}, 0.00000},
             {dB_t{11.00}, 0.00000}, {dB_t{11.25}, 0.00000}, {dB_t{11.50}, 0.00000},
             {dB_t{11.75}, 0.00000}, {dB_t{12.00}, 0.00000}, {dB_t{12.25}, 0.00000},
             {dB_t{12.50}, 0.00000}, {dB_t{12.75}, 0.00000}, {dB_t{13.00}, 0.00000},
             {dB_t{13.25}, 0.00000}, {dB_t{13.50}, 0.00000}, {dB_t{13.75}, 0.00000},
             {dB_t{14.00}, 0.00000}, {dB_t{14.25}, 0.00000}, {dB_t{14.50}, 0.00000},
             {dB_t{14.75}, 0.00000}, {dB_t{15.00}, 0.00000}, {dB_t{15.25}, 0.00000},
             {dB_t{15.50}, 0.00000}, {dB_t{15.75}, 0.00000}, {dB_t{16.00}, 0.00000},
             {dB_t{16.25}, 0.00000}, {dB_t{16.50}, 0.00000}, {dB_t{16.75}, 0.00000},
             {dB_t{17.00}, 0.00000}, {dB_t{17.25}, 0.00000}, {dB_t{17.50}, 0.00000},
             {dB_t{17.75}, 0.00000}, {dB_t{18.00}, 0.00000}, {dB_t{18.25}, 0.00000},
             {dB_t{18.50}, 0.00000}, {dB_t{18.75}, 0.00000}, {dB_t{19.00}, 0.00000},
             {dB_t{19.25}, 0.00000}, {dB_t{19.50}, 0.00000}, {dB_t{19.75}, 0.00000},
             {dB_t{20.00}, 0.00000}, {dB_t{20.25}, 0.00000}, {dB_t{20.50}, 0.00000},
             {dB_t{20.75}, 0.00000}, {dB_t{21.00}, 0.00000}, {dB_t{21.25}, 0.00000},
             {dB_t{21.50}, 0.00000}, {dB_t{21.75}, 0.00000}, {dB_t{22.00}, 0.00000},
             {dB_t{22.25}, 0.00000}, {dB_t{22.50}, 0.00000}, {dB_t{22.75}, 0.00000},
             {dB_t{23.00}, 0.00000}, {dB_t{23.25}, 0.00000}, {dB_t{23.50}, 0.00000},
             {dB_t{23.75}, 0.00000}, {dB_t{24.00}, 0.00000}, {dB_t{24.25}, 0.00000},
             {dB_t{24.50}, 0.00000}, {dB_t{24.75}, 0.00000}, {dB_t{25.00}, 0.00000},
             {dB_t{25.25}, 0.00000}, {dB_t{25.50}, 0.00000}, {dB_t{25.75}, 0.00000},
             {dB_t{26.00}, 0.00000}, {dB_t{26.25}, 0.00000}, {dB_t{26.50}, 0.00000},
             {dB_t{26.75}, 0.00000}, {dB_t{27.00}, 0.00000}, {dB_t{27.25}, 0.00000},
             {dB_t{27.50}, 0.00000}, {dB_t{27.75}, 0.00000}, {dB_t{28.00}, 0.00000},
             {dB_t{28.25}, 0.00000}, {dB_t{28.50}, 0.00000}, {dB_t{28.75}, 0.00000},
             {dB_t{29.00}, 0.00000}, {dB_t{29.25}, 0.00000}, {dB_t{29.50}, 0.00000},
             {dB_t{29.75}, 0.00000}, {dB_t{30.00}, 0.00000},
         }},
        /* MCS 0 - 32 bytes */
        {std::make_pair(0, 32),
         {
             {dB_t{-4.00}, 1.00000}, {dB_t{-3.75}, 1.00000}, {dB_t{-3.50}, 1.00000},
             {dB_t{-3.25}, 0.99750}, {dB_t{-3.00}, 0.99500}, {dB_t{-2.75}, 0.96790},
             {dB_t{-2.50}, 0.94080}, {dB_t{-2.25}, 0.88335}, {dB_t{-2.00}, 0.82590},
             {dB_t{-1.75}, 0.70770}, {dB_t{-1.50}, 0.58950}, {dB_t{-1.25}, 0.44890},
             {dB_t{-1.00}, 0.30830}, {dB_t{-0.75}, 0.21685}, {dB_t{-0.50}, 0.12540},
             {dB_t{-0.25}, 0.07990}, {dB_t{0.00}, 0.03440},  {dB_t{0.25}, 0.02145},
             {dB_t{0.50}, 0.00850},  {dB_t{0.75}, 0.00500},  {dB_t{1.00}, 0.00150},
             {dB_t{1.25}, 0.00087},  {dB_t{1.50}, 0.00024},  {dB_t{1.75}, 0.00017},
             {dB_t{2.00}, 0.00009},  {dB_t{2.25}, 0.00005},  {dB_t{2.50}, 0.00000},
             {dB_t{2.75}, 0.00000},  {dB_t{3.00}, 0.00000},  {dB_t{3.25}, 0.00000},
             {dB_t{3.50}, 0.00000},  {dB_t{3.75}, 0.00000},  {dB_t{4.00}, 0.00000},
             {dB_t{4.25}, 0.00000},  {dB_t{4.50}, 0.00000},  {dB_t{4.75}, 0.00000},
             {dB_t{5.00}, 0.00000},  {dB_t{5.25}, 0.00000},  {dB_t{5.50}, 0.00000},
             {dB_t{5.75}, 0.00000},  {dB_t{6.00}, 0.00000},  {dB_t{6.25}, 0.00000},
        ...
        {std::make_pair(0, 1000),
         {
             ...
             {dB_t{-2.50}, 1.00000}, {dB_t{-2.25}, 1.00000}, {dB_t{-2.00}, 1.00000},
             {dB_t{-1.75}, 1.00000}, {dB_t{-1.50}, 1.00000}, {dB_t{-1.25}, 1.00000},
             {dB_t{-1.00}, 1.00000}, {dB_t{-0.75}, 0.98140}, {dB_t{-0.50}, 0.97007},
             {dB_t{-0.25}, 0.80280}, {dB_t{0.00}, 0.68977},  {dB_t{0.25}, 0.42581},
             {dB_t{0.50}, 0.20997},  {dB_t{0.75}, 0.12620},  {dB_t{1.00}, 0.04596},
             {dB_t{1.25}, 0.02674},  {dB_t{1.50}, 0.00770},  {dB_t{1.75}, 0.00436},
             {dB_t{2.00}, 0.00103},  {dB_t{2.25}, 0.00057},  {dB_t{2.50}, 0.00010},
             {dB_t{2.75}, 0.00005},  {dB_t{3.00}, 0.00001},  {dB_t{3.25}, 0.00000},
             {dB_t{3.50}, 0.00000},  {dB_t{3.75}, 0.00000},  {dB_t{4.00}, 0.00000},
             {dB_t{4.25}, 0.00000},  {dB_t{4.50}, 0.00000},  {dB_t{4.75}, 0.00000},
             {dB_t{5.00}, 0.00000},  {dB_t{5.25}, 0.00000},  {dB_t{5.50}, 0.00000},
             {dB_t{5.75}, 0.00000},  {dB_t{6.00}, 0.00000},  {dB_t{6.25}, 0.00000},
        ...
        {std::make_pair(0, 1),
         {
             {dB_t{-4.00}, 1.00000}, {dB_t{-3.75}, 1.00000}, {dB_t{-3.50}, 1.00000},
             {dB_t{-3.25}, 0.17075}, {dB_t{-3.00}, 0.15260}, {dB_t{-2.75}, 0.10190},
             {dB_t{-2.50}, 0.08455}, {dB_t{-2.25}, 0.06494}, {dB_t{-2.00}, 0.05316},
             {dB_t{-1.75}, 0.03771}, {dB_t{-1.50}, 0.02744}, {dB_t{-1.25}, 0.01845},
             {dB_t{-1.00}, 0.01145}, {dB_t{-0.75}, 0.00761}, {dB_t{-0.50}, 0.00418},
             {dB_t{-0.25}, 0.00260}, {dB_t{0.00}, 0.00110},  {dB_t{0.25}, 0.00068},
             {dB_t{0.50}, 0.00027},  {dB_t{0.75}, 0.00016},  {dB_t{1.00}, 0.00005},
             {dB_t{1.25}, 0.00003},  {dB_t{1.50}, 0.00000},  {dB_t{1.75}, 0.00000},
             {dB_t{2.00}, 0.00000},  {dB_t{2.25}, 0.00000},  {dB_t{2.50}, 0.00000},
             {dB_t{2.75}, 0.00000},  {dB_t{3.00}, 0.00000},  {dB_t{3.25}, 0.00000},
             {dB_t{3.50}, 0.00000},  {dB_t{3.75}, 0.00000},  {dB_t{4.00}, 0.00000},
             {dB_t{4.25}, 0.00000},  {dB_t{4.50}, 0.00000},  {dB_t{4.75}, 0.00000},
             {dB_t{5.00}, 0.00000},  {dB_t{5.25}, 0.00000},  {dB_t{5.50}, 0.00000},
        ...
        {std::make_pair(0, 2000),
         {
             ...
             {dB_t{-2.50}, 1.00000}, {dB_t{-2.25}, 1.00000}, {dB_t{-2.00}, 1.00000},
             {dB_t{-1.75}, 1.00000}, {dB_t{-1.50}, 1.00000}, {dB_t{-1.25}, 1.00000},
             {dB_t{-1.00}, 1.00000}, {dB_t{-0.75}, 0.99965}, {dB_t{-0.50}, 0.99910},
             {dB_t{-0.25}, 0.96111}, {dB_t{0.00}, 0.90376},  {dB_t{0.25}, 0.67031},
             {dB_t{0.50}, 0.37584},  {dB_t{0.75}, 0.23647},  {dB_t{1.00}, 0.08981},
             {dB_t{1.25}, 0.05277},  {dB_t{1.50}, 0.01533},  {dB_t{1.75}, 0.00870},
             {dB_t{2.00}, 0.00206},  {dB_t{2.25}, 0.00113},  {dB_t{2.50}, 0.00021},
             {dB_t{2.75}, 0.00011},  {dB_t{3.00}, 0.00001},  {dB_t{3.25}, 0.00000},
             {dB_t{3.50}, 0.00000},  {dB_t{3.75}, 0.00000},  {dB_t{4.00}, 0.00000},
             {dB_t{4.25}, 0.00000},  {dB_t{4.50}, 0.00000},  {dB_t{4.75}, 0.00000},
             {dB_t{5.00}, 0.00000},  {dB_t{5.25}, 0.00000},  {dB_t{5.50}, 0.00000},
             {dB_t{5.75}, 0.00000},  {dB_t{6.00}, 0.00000},  {dB_t{6.25}, 0.00000},
        ...
        {std::make_pair(7, 1500),
         {
             ...
             {dB_t{-2.50}, 1.00000}, {dB_t{-2.25}, 1.00000}, {dB_t{-2.00}, 1.00000},
             {dB_t{-1.75}, 1.00000}, {dB_t{-1.50}, 1.00000}, {dB_t{-1.25}, 1.00000},
             {dB_t{-1.00}, 1.00000}, {dB_t{-0.75}, 1.00000}, {dB_t{-0.50}, 1.00000},
             {dB_t{-0.25}, 1.00000}, {dB_t{0.00}, 1.00000},  {dB_t{0.25}, 1.00000},
             {dB_t{0.50}, 1.00000},  {dB_t{0.75}, 1.00000},  {dB_t{1.00}, 1.00000},
             {dB_t{1.25}, 1.00000},  {dB_t{1.50}, 1.00000},  {dB_t{1.75}, 1.00000},
             {dB_t{2.00}, 1.00000},  {dB_t{2.25}, 1.00000},  {dB_t{2.50}, 1.00000},
             {dB_t{2.75}, 1.00000},  {dB_t{3.00}, 1.00000},  {dB_t{3.25}, 1.00000},
             {dB_t{3.50}, 1.00000},  {dB_t{3.75}, 1.00000},  {dB_t{4.00}, 1.00000},
             {dB_t{4.25}, 1.00000},  {dB_t{4.50}, 1.00000},  {dB_t{4.75}, 1.00000},
             {dB_t{5.00}, 1.00000},  {dB_t{5.25}, 1.00000},  {dB_t{5.50}, 1.00000},
             {dB_t{5.75}, 1.00000},  {dB_t{6.00}, 1.00000},  {dB_t{6.25}, 1.00000},
             {dB_t{6.50}, 1.00000},  {dB_t{6.75}, 1.00000},  {dB_t{7.00}, 1.00000},
             {dB_t{7.25}, 1.00000},  {dB_t{7.50}, 1.00000},  {dB_t{7.75}, 1.00000},
             {dB_t{8.00}, 1.00000},  {dB_t{8.25}, 1.00000},  {dB_t{8.50}, 1.00000},
             {dB_t{8.75}, 1.00000},  {dB_t{9.00}, 1.00000},  {dB_t{9.25}, 1.00000},
             {dB_t{9.50}, 1.00000},  {dB_t{9.75}, 1.00000},  {dB_t{10.00}, 1.00000},
             {dB_t{10.25}, 1.00000}, {dB_t{10.50}, 1.00000}, {dB_t{10.75}, 1.00000},
             {dB_t{11.00}, 1.00000}, {dB_t{11.25}, 1.00000}, {dB_t{11.50}, 1.00000},
             {dB_t{11.75}, 1.00000}, {dB_t{12.00}, 1.00000}, {dB_t{12.25}, 1.00000},
             {dB_t{12.50}, 1.00000}, {dB_t{12.75}, 1.00000}, {dB_t{13.00}, 1.00000},
             {dB_t{13.25}, 1.00000}, {dB_t{13.50}, 1.00000}, {dB_t{13.75}, 1.00000},
             {dB_t{14.00}, 1.00000}, {dB_t{14.25}, 1.00000}, {dB_t{14.50}, 1.00000},
             {dB_t{14.75}, 1.00000}, {dB_t{15.00}, 1.00000}, {dB_t{15.25}, 1.00000},
             {dB_t{15.50}, 1.00000}, {dB_t{15.75}, 1.00000}, {dB_t{16.00}, 1.00000},
             {dB_t{16.25}, 1.00000}, {dB_t{16.50}, 1.00000}, {dB_t{16.75}, 1.00000},
             {dB_t{17.00}, 1.00000}, {dB_t{17.25}, 1.00000}, {dB_t{17.50}, 1.00000},
             {dB_t{17.75}, 0.99057}, {dB_t{18.00}, 0.98075}, {dB_t{18.25}, 0.86664},
             {dB_t{18.50}, 0.74920}, {dB_t{18.75}, 0.54857}, {dB_t{19.00}, 0.34531},
             {dB_t{19.25}, 0.23624}, {dB_t{19.50}, 0.12672}, {dB_t{19.75}, 0.08164},
             {dB_t{20.00}, 0.03650}, {dB_t{20.25}, 0.02340}, {dB_t{20.50}, 0.01029},
             {dB_t{20.75}, 0.00653}, {dB_t{21.00}, 0.00278}, {dB_t{21.25}, 0.00165},
             {dB_t{21.50}, 0.00051}, {dB_t{21.75}, 0.00030}, {dB_t{22.00}, 0.00009},
             {dB_t{22.25}, 0.00005}, {dB_t{22.50}, 0.00001}, {dB_t{22.75}, 0.00000},
             {dB_t{23.00}, 0.00000}, {dB_t{23.25}, 0.00000}, {dB_t{23.50}, 0.00000},
             {dB_t{23.75}, 0.00000}, {dB_t{24.00}, 0.00000}, {dB_t{24.25}, 0.00000},
             {dB_t{24.50}, 0.00000}, {dB_t{24.75}, 0.00000}, {dB_t{25.00}, 0.00000},
             {dB_t{25.25}, 0.00000}, {dB_t{25.50}, 0.00000}, {dB_t{25.75}, 0.00000},
        ...
        {std::make_pair(8, 1500),
         {
             ...
             {dB_t{16.25}, 1.00000}, {dB_t{16.50}, 1.00000}, {dB_t{16.75}, 1.00000},
             {dB_t{17.00}, 1.00000}, {dB_t{17.25}, 1.00000}, {dB_t{17.50}, 1.00000},
             {dB_t{17.75}, 1.00000}, {dB_t{18.00}, 1.00000}, {dB_t{18.25}, 1.00000},
             {dB_t{18.50}, 1.00000}, {dB_t{18.75}, 1.00000}, {dB_t{19.00}, 1.00000},
             {dB_t{19.25}, 1.00000}, {dB_t{19.50}, 1.00000}, {dB_t{19.75}, 1.00000},
             {dB_t{20.00}, 1.00000}, {dB_t{20.25}, 1.00000}, {dB_t{20.50}, 1.00000},
             {dB_t{20.75}, 1.00000}, {dB_t{21.00}, 1.00000}, {dB_t{21.25}, 0.99918},
             {dB_t{21.50}, 0.99833}, {dB_t{21.75}, 0.97191}, {dB_t{22.00}, 0.94458},
             {dB_t{22.25}, 0.81436}, {dB_t{22.50}, 0.68127}, {dB_t{22.75}, 0.52168},
             {dB_t{23.00}, 0.36056}, {dB_t{23.25}, 0.25114}, {dB_t{23.50}, 0.14127},
             {dB_t{23.75}, 0.09509}, {dB_t{24.00}, 0.04883}, {dB_t{24.25}, 0.03234},
             {dB_t{24.50}, 0.01584}, {dB_t{24.75}, 0.01060}, {dB_t{25.00}, 0.00535},
             {dB_t{25.25}, 0.00345}, {dB_t{25.50}, 0.00154}, {dB_t{25.75}, 0.00096},
             {dB_t{26.00}, 0.00037}, {dB_t{26.25}, 0.00022}, {dB_t{26.50}, 0.00007},
             {dB_t{26.75}, 0.00004}, {dB_t{27.00}, 0.00000}, {dB_t{27.25}, 0.00000},
             {dB_t{27.50}, 0.00000}, {dB_t{27.75}, 0.00000}, {dB_t{28.00}, 0.00000},
             {dB_t{28.25}, 0.00000}, {dB_t{28.50}, 0.00000}, {dB_t{28.75}, 0.00000},
             {dB_t{29.00}, 0.00000}, {dB_t{29.25}, 0.00000}, {dB_t{29.50}, 0.00000},
             {dB_t{29.75}, 0.00000}, {dB_t{30.00}, 0.00000},
...
TableBasedErrorRateTestCase::DoRun()
{
    ...
    {
        dB_t snr{snrMultipliedByFour / 4.0};
        ...
        else
        {
            ...
            if (it != expectedTableValues.end())
            {
                ...
                {
                    NS_FATAL_ERROR("SNR value " << snr << " not found!");
                }
            }
            else
            {
