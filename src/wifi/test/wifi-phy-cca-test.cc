...
constexpr MHz_t P20_CENTER_FREQUENCY{5955};
constexpr MHz_t S20_CENTER_FREQUENCY = P20_CENTER_FREQUENCY + MHz_t{20};
constexpr MHz_t P40_CENTER_FREQUENCY = P20_CENTER_FREQUENCY + MHz_t{10};
constexpr MHz_t S40_CENTER_FREQUENCY = P40_CENTER_FREQUENCY + MHz_t{40};
constexpr MHz_t P80_CENTER_FREQUENCY = P40_CENTER_FREQUENCY + MHz_t{20};
constexpr MHz_t S80_CENTER_FREQUENCY = P80_CENTER_FREQUENCY + MHz_t{80};
constexpr MHz_t P160_CENTER_FREQUENCY = P80_CENTER_FREQUENCY + MHz_t{40};
constexpr MHz_t S160_CENTER_FREQUENCY = P160_CENTER_FREQUENCY + MHz_t{160};
constexpr MHz_t P320_CENTER_FREQUENCY = P160_CENTER_FREQUENCY + MHz_t{80};
...
const std::map<MHz_t, Time> hePpduDurations = {
    {MHz_t{20}, NanoSeconds(1009600)},
    {MHz_t{40}, NanoSeconds(533600)},
    {MHz_t{80}, NanoSeconds(275200)},
};
const std::map<MHz_t, Time> ehtPpduDurations = {
    {MHz_t{20}, NanoSeconds(1017600)},
    {MHz_t{40}, NanoSeconds(541600)},
    {MHz_t{80}, NanoSeconds(287200)},
    {MHz_t{160}, NanoSeconds(178400)},
};
...
class WifiPhyCcaThresholdsTest : public TestCase
{
  ...
  private:
     ...
     * @return a HT PPDU
     */
    Ptr<HtPpdu> CreateDummyHtPpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel);
    /**
     * Create a VHT PPDU
     * @param bandwidth the bandwidth used for the transmission the PPDU
     * @param channel the operating channel of the PHY used for the transmission
     * @return a VHT PPDU
     */
    Ptr<VhtPpdu> CreateDummyVhtPpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel);
    /**
     * Create a HE PPDU
     * @param bandwidth the bandwidth used for the transmission the PPDU
     * @param channel the operating channel of the PHY used for the transmission
     * @return a HE PPDU
     */
    Ptr<HePpdu> CreateDummyHePpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel);
    /**
     * Create a EHT PPDU
     * @param bandwidth the bandwidth used for the transmission the PPDU
     * @param channel the operating channel of the PHY used for the transmission
     * @return a EHT PPDU
     */
    Ptr<EhtPpdu> CreateDummyEhtPpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel);
    ...
    dBm_t m_CcaEdThreshold; ///< The current CCA-ED threshold for a 20 MHz subchannel
    dBm_t m_CcaSensitivity; ///< The current CCA sensitivity threshold for signals that occupy the
    ...
    dBm_t m_obssPdLevel;         ///< The current OBSS-PD level
    dBm_t m_per20CcaSensitivity; ///< The current CCA sensitivity threshold for Per 20MHz check
};
...
WifiPhyCcaThresholdsTest::WifiPhyCcaThresholdsTest()
    : TestCase("Wi-Fi PHY CCA thresholds test"),
      m_CcaEdThreshold{-62},
      m_CcaSensitivity{-82},
      m_secondaryCcaSensitivityThresholds{dBm_t{-72}, dBm_t{-72}, dBm_t{-69}},
      m_obssPdLevel{-82},
      m_per20CcaSensitivity{-72}
{
}
...
Ptr<HtPpdu>
WifiPhyCcaThresholdsTest::CreateDummyHtPpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel)
{
...
Ptr<VhtPpdu>
WifiPhyCcaThresholdsTest::CreateDummyVhtPpdu(MHz_t bandwidth,
...
Ptr<HePpdu>
WifiPhyCcaThresholdsTest::CreateDummyHePpdu(MHz_t bandwidth, const WifiPhyOperatingChannel& channel)
{
...
Ptr<EhtPpdu>
WifiPhyCcaThresholdsTest::CreateDummyEhtPpdu(MHz_t bandwidth,
                                             const WifiPhyOperatingChannel& channel)
{
                                             ...
                                             dBm_t expectedCcaThreshold)
{
    ...
    NS_LOG_INFO((ppdu == nullptr ? "any signal" : "a PPDU")
                << " in " << channelType << " channel: " << actualThreshold);
    NS_TEST_EXPECT_MSG_EQ_TOL(actualThreshold,
                              ...
                              "Actual CCA threshold for "
                                  ...
                                  << " does not match expected threshold " << expectedCcaThreshold);
}
...
WifiPhyCcaThresholdsTest::RunOne()
{
    ...
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HT),
                       CreateDummyHtPpdu(MHz_t{20}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HT),
                       CreateDummyHtPpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_VHT),
                       CreateDummyVhtPpdu(MHz_t{20}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_VHT),
                       CreateDummyVhtPpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_VHT),
                       CreateDummyVhtPpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_VHT),
                       CreateDummyVhtPpdu(MHz_t{160}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HE),
                       CreateDummyHePpdu(MHz_t{20}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HE),
                       CreateDummyHePpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HE),
                       CreateDummyHePpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_HE),
                       CreateDummyHePpdu(MHz_t{160}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    VerifyCcaThreshold(
        ...
        CreateDummyHePpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
        WIFI_CHANLIST_SECONDARY40,
        std::max(m_obssPdLevel + dB_t{3.0}, std::get<1>(m_secondaryCcaSensitivityThresholds)));
    ...
    VerifyCcaThreshold(
        ...
        CreateDummyHePpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
        WIFI_CHANLIST_SECONDARY80,
        std::max(m_obssPdLevel + dB_t{6.0}, std::get<2>(m_secondaryCcaSensitivityThresholds)));
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{20}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    // EHT PHY: 40 MHz EHT PPDU in primary channel (20 MHz) if power in primary above CCA
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{160}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // sensitivity threshold
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{320}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_PRIMARY,
                       m_CcaSensitivity);
    ...
    // EHT PHY: 20 MHz EHT PPDU in secondary40 channel (40 MHz) if power above the max between the
    // CCA sensitivity threshold for Per 20MHz check and the OBSS-PD level
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{20}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_SECONDARY40,
    ...
    // EHT PHY: 40 MHz EHT PPDU in secondary40 channel (40 MHz) if power above the max between the
    // CCA sensitivity threshold for Per 20MHz check and the OBSS-PD level
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_SECONDARY40,
    ...
    // EHT PHY: 20 MHz EHT PPDU in secondary80 channel (80 MHz) if power above the max between the
    // CCA sensitivity threshold for Per 20MHz check and the OBSS-PD level
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_SECONDARY80,
    ...
    // EHT PHY: 40 MHz EHT PPDU in secondary80 channel (80 MHz) if power above the max between the
    // CCA sensitivity threshold for Per 20MHz check and the OBSS-PD level
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{40}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_SECONDARY80,
    ...
    // EHT PHY: 80 MHz EHT PPDU in secondary80 channel (80 MHz) if power above the max between the
    // CCA sensitivity threshold for Per 20MHz check and the OBSS-PD level
    VerifyCcaThreshold(m_phy->GetPhyEntity(WIFI_MOD_CLASS_EHT),
                       CreateDummyEhtPpdu(MHz_t{80}, m_phy->GetOperatingChannel()),
                       WIFI_CHANLIST_SECONDARY80,
    ...
    // EHT PHY: 160 MHz EHT PPDU in secondary160 channel (160 MHz) if power above the max between
...
{
    // default attributes
    m_CcaEdThreshold = dBm_t{-62};
    m_CcaSensitivity = dBm_t{-82};
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-72}, dBm_t{-72}, dBm_t{-69});
    m_obssPdLevel = dBm_t{-82};
    m_per20CcaSensitivity = dBm_t{-72};
    RunOne();
    ...
    m_CcaSensitivity = dBm_t{-82};
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-72}, dBm_t{-72}, dBm_t{-69});
    m_obssPdLevel = dBm_t{-70};
    m_per20CcaSensitivity = dBm_t{-72};
    RunOne();

    // CCA-ED set to -65 dBm
    m_CcaEdThreshold = dBm_t{-65};
    m_CcaSensitivity = dBm_t{-82};
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-72}, dBm_t{-72}, dBm_t{-69});
    m_obssPdLevel = dBm_t{-82};
    m_per20CcaSensitivity = dBm_t{-72};
    ...
    m_CcaEdThreshold = dBm_t{-62};
    m_CcaSensitivity = dBm_t{-72};
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-70}, dBm_t{-70}, dBm_t{-70});
    m_obssPdLevel = dBm_t{-82};
    m_per20CcaSensitivity = dBm_t{-75};
    RunOne();
    ...
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-70}, dBm_t{-70}, dBm_t{-70});
    m_obssPdLevel = dBm_t{-80};
    m_per20CcaSensitivity = dBm_t{-69};
    RunOne();
    ...
    m_secondaryCcaSensitivityThresholds = std::make_tuple(dBm_t{-70}, dBm_t{-70}, dBm_t{-70});
    m_obssPdLevel = dBm_t{-70};
    m_per20CcaSensitivity = dBm_t{-66};
    RunOne();
...
class WifiPhyCcaIndicationTest : public TestCase
{
  ...
  private:
     ...
     */
    void SendSuPpdu(dBm_t txPower, MHz_t frequency, MHz_t bandwidth);
     ...
     */
    void UpdateCcaThreshold(dBm_t ccaThreshold);
    ...
    struct TxSignalInfo
    {
        dBm_t power;      //!< transmit power to use
        Time startTime;   //!< time at which transmission will be started
        Time duration;    //!< the duration of the transmission
        MHz_t centerFreq; //!< center frequency to use
        MHz_t bandwidth;  //!< bandwidth to use
    };
    ...
    struct CcaThresholdUpdatePoint
    {
        ...
        dBm_t ccaThreshold; //!< new CCA threshold value to be set
    };
    ...
    MHz_t m_frequency;    ///< Operating frequency
                                      ...
                                      Time duration)
{
    ...
    BandInfo bandInfo;
    bandInfo.fc = frequency.in_Hz();
    bandInfo.fl = bandInfo.fc - (bandwidth / 2).in_Hz();
    bandInfo.fh = bandInfo.fc + (bandwidth / 2).in_Hz();
    Bands bands;
    ...
    *signalPsd = DbmToW(txPower).in_Watt() / bandwidth.in_Hz();
...
void
WifiPhyCcaIndicationTest::SendSuPpdu(dBm_t txPower, MHz_t frequency, MHz_t bandwidth)
{
    ...
    m_txPhy->SetOperatingChannel(
        WifiPhy::ChannelTuple{channelNum, bandwidth.in_MHz(), WIFI_PHY_BAND_6GHZ, 0});
...
void
WifiPhyCcaIndicationTest::UpdateCcaThreshold(dBm_t ccaThreshold)
{
...
WifiPhyCcaIndicationTest::Reset()
{
    ...
    UpdateCcaThreshold(dBm_t{-62}); // restore default CCA threshold
}
...
WifiPhyCcaIndicationTest::RunOne()
{
    ...
    m_rxPhy->SetOperatingChannel(
        WifiPhy::ChannelTuple{channelNum, m_channelWidth.in_MHz(), WIFI_PHY_BAND_6GHZ, 0});
    m_txPhy->SetOperatingChannel(
        WifiPhy::ChannelTuple{channelNum, m_channelWidth.in_MHz(), WIFI_PHY_BAND_6GHZ, 0});
    ...
    ScheduleTest(
        ...
        {{dBm_t{-65}, tx1Start, txDuration1, P20_CENTER_FREQUENCY, MHz_t{20}}},
        {},
        {
    ...
    ScheduleTest(
        ...
        {{dBm_t{-60}, tx1Start, txDuration1, P20_CENTER_FREQUENCY, MHz_t{20}}},
        {},
        {
    ...
    ScheduleTest(
        ...
        {{dBm_t{-64}, tx1Start, txDuration1, P20_CENTER_FREQUENCY, MHz_t{20}},
         {dBm_t{-65}, tx2Start, txDuration2, P20_CENTER_FREQUENCY, MHz_t{20}}},
        {},
        {
    ...
    ScheduleTest(delay,
                 ...
                 {},
                 {{dBm_t{-85}, tx1Start, P20_CENTER_FREQUENCY, MHz_t{20}}},
                 {
                     {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                     {ppduDurations.at(MHz_t{20}) - smallDelta,
                      WifiPhyState::IDLE}, // IDLE just before the transmission ends
                     {ppduDurations.at(MHz_t{20}) + smallDelta,
    ...
    ScheduleTest(
        ...
        {},
        {{dBm_t{-80}, tx1Start, P20_CENTER_FREQUENCY, MHz_t{20}}},
        {
            {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
            {ppduDurations.at(MHz_t{20}) - smallDelta,
    ...
    ScheduleTest(delay,
                 ...
                 {},
                 {{dBm_t{-80}, tx1Start, P40_CENTER_FREQUENCY, MHz_t{40}}},
                 {
                     {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                     {ppduDurations.at(MHz_t{40}) - smallDelta,
                      WifiPhyState::IDLE}, // IDLE just before the transmission ends
                     {ppduDurations.at(MHz_t{40}) + smallDelta,
                      WifiPhyState::IDLE} // IDLE just after the transmission ends
                 },
    ...
    ScheduleTest(
        ...
        {},
        {{dBm_t{-75}, tx1Start, P40_CENTER_FREQUENCY, MHz_t{40}}},
        {
            {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
            {ppduDurations.at(MHz_t{40}) - smallDelta,
    ...
    if (m_channelWidth > MHz_t{20})
    {
        ...
        ScheduleTest(delay,
                     ...
                     {{dBm_t{-65}, tx1Start, txDuration1, S20_CENTER_FREQUENCY, MHz_t{20}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(delay,
                     ...
                     {{dBm_t{-60}, tx1Start, txDuration1, S20_CENTER_FREQUENCY, MHz_t{20}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55}, tx1Start, txDuration1, P40_CENTER_FREQUENCY, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "that occupies P20",
            {{dBm_t{-60}, tx1Start, txDuration1, S20_CENTER_FREQUENCY, MHz_t{20}},
             {dBm_t{-60}, tx2Start, txDuration2, P20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
        ...
        ScheduleTest(
            ...
            "that occupies S20",
            {{dBm_t{-60}, tx1Start, txDuration1, P20_CENTER_FREQUENCY, MHz_t{20}},
             {dBm_t{-60}, tx2Start, txDuration2, S20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
                {tx2Start + aCcaTimeWithDelta,
        ...
        ScheduleTest(delay,
                     ...
                     {},
                     {{dBm_t{-75}, tx1Start, S20_CENTER_FREQUENCY, MHz_t{20}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{20}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
        ...
        m_expectedPer20MhzCcaBusyDurations.at(0).at(1) = ppduDurations.at(MHz_t{20});
        ScheduleTest(delay,
                     "Reception of a 20 MHz PPDU that occupies S20 above CCA sensitivity threshold",
                     {},
                     {{dBm_t{-70}, tx1Start, S20_CENTER_FREQUENCY, MHz_t{20}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{20}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
        ...
        ScheduleTest(
            ...
            {{dBm_t{-60},
              ...
              MHz_t{20}}}, // signal on S20 above threshold
            {{dBm_t{-80},
              tx2Start,
              P40_CENTER_FREQUENCY,
              MHz_t{40}}}, // PPDU on P40 below threshold
            {
    ...
    if (m_channelWidth > MHz_t{40})
    {
        ...
        ScheduleTest(
            delay,
            "Reception of a signal that occupies P20 below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S40_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "ED threshold",
            {{dBm_t{-55}, tx1Start, txDuration1, S40_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(delay,
                     ...
                     {{dBm_t{-60}, tx1Start, txDuration1, S40_CENTER_FREQUENCY, MHz_t{40}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "threshold",
            {{dBm_t{-55}, tx1Start, txDuration1, S40_CENTER_FREQUENCY, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55}, tx1Start, txDuration1, P80_CENTER_FREQUENCY, MHz_t{80}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55}, tx1Start, txDuration1, S40_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}},
             {dBm_t{-55}, tx2Start, txDuration2, P20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(
            ...
            "that occupies S20",
            {{dBm_t{-55}, tx1Start, txDuration1, S40_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}},
             {dBm_t{-55}, tx2Start, txDuration2, S20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(delay,
                     ...
                     {},
                     {{dBm_t{-75}, tx1Start, S40_CENTER_FREQUENCY, MHz_t{40}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{40}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55},
              ...
              MHz_t{40}}}, // signal on S40 above threshold
            {{dBm_t{-80},
              tx2Start,
              P80_CENTER_FREQUENCY,
              MHz_t{80}}}, // PPDU on P80 below threshold
            {
                {tx2Start + aCcaTimeWithDelta, WifiPhyState::IDLE}, // PHY state stays IDLE
            },
            {{tx2Start - smallDelta,
    ...
    else // 20 or 40 MHz receiver
    {
        ...
        ScheduleTest(
            ...
            "threshold",
            {},
            {{dBm_t{-70}, tx1Start, P80_CENTER_FREQUENCY, MHz_t{80}}},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA_BUSY after aCcaTimeWithDelta
                {ppduDurations.at(MHz_t{80}) - smallDelta,
        ...
        if (m_channelWidth > MHz_t{20})
        {
            std::fill_n(m_expectedPer20MhzCcaBusyDurations.at(0).begin(),
                        2,
                        ppduDurations.at(MHz_t{80}) - aCcaTime);
            std::fill_n(m_expectedPer20MhzCcaBusyDurations.at(1).begin(),
                        2,
                        ppduDurations.at(MHz_t{80}) - hePhyHeaderDuration);
        }
        ScheduleTest(
            delay,
            "Reception of a 80 MHz PPDU that occupies the 40 MHz band above CCA sensitivity "
            "threshold",
            {},
            {{dBm_t{-55}, tx1Start, P80_CENTER_FREQUENCY, MHz_t{80}}},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA_BUSY after aCcaTimeWithDelta
                {ppduDurations.at(MHz_t{80}) - smallDelta,
                 WifiPhyState::CCA_BUSY}, // CCA_BUSY just before the transmission ends
        ...
        ScheduleTest(delay,
                     ...
                     {},
                     {{dBm_t{-50}, tx1Start, S40_CENTER_FREQUENCY, MHz_t{40}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{20}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
    ...
    if (m_channelWidth > MHz_t{80})
    {
        ...
        ScheduleTest(
            ...
            "ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{30}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "ED threshold",
            {{dBm_t{-55}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{30}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "Reception of a 20 MHz signal that occupies the second subchannel of S80 "
            "above ED threshold",
            {{dBm_t{-55}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-65}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{20}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55}, tx1Start, txDuration1, S80_CENTER_FREQUENCY - MHz_t{20}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(delay,
                     ...
                     {{dBm_t{-65}, tx1Start, txDuration1, S80_CENTER_FREQUENCY, MHz_t{80}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(delay,
                     ...
                     {{dBm_t{-55}, tx1Start, txDuration1, S80_CENTER_FREQUENCY, MHz_t{80}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(delay,
                     ...
                     "threshold",
                     {{dBm_t{-55}, tx1Start, txDuration1, P160_CENTER_FREQUENCY, MHz_t{160}}},
                     {},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "threshold",
            {{dBm_t{-50}, tx1Start, txDuration1, P160_CENTER_FREQUENCY, MHz_t{160}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "that occupies S40",
            {{dBm_t{-55}, tx1Start, txDuration1, S80_CENTER_FREQUENCY + MHz_t{30}, MHz_t{20}},
             {dBm_t{-55}, tx2Start, txDuration2, S40_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE},            // state of primary stays idle
                                                                    // after aCcaTimeWithDelta
        ...
        ScheduleTest(delay,
                     ...
                     "threshold",
                     {},
                     {{dBm_t{-70}, tx1Start, S80_CENTER_FREQUENCY, MHz_t{80}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{80}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
        ...
        ScheduleTest(delay,
                     ...
                     "threshold",
                     {},
                     {{dBm_t{-65}, tx1Start, S80_CENTER_FREQUENCY, MHz_t{80}}},
                     {
                         {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                         {ppduDurations.at(MHz_t{80}) - smallDelta,
                          WifiPhyState::IDLE}, // IDLE just before the transmission ends
        ...
        if (m_standard == WIFI_STANDARD_80211ax)
        {
            ...
            ScheduleTest(
                ...
                {{dBm_t{-60}, tx1Start, txDuration1, S80_CENTER_FREQUENCY + MHz_t{30}, MHz_t{20}}},
                {},
                {
                    {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                    {txEndSignal1 - smallDelta,
            ...
            ScheduleTest(
                ...
                {{dBm_t{-50}, tx1Start, txDuration1, P80_CENTER_FREQUENCY, MHz_t{80}},
                 {dBm_t{-60}, tx2Start, txDuration2, S80_CENTER_FREQUENCY + MHz_t{30}, MHz_t{20}}},
                {},
                {
                    {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
    ...
    if (m_channelWidth > MHz_t{160})
    {
        ...
        ScheduleTest(
            ...
            "below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{70}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "Reception of a 20 MHz signal that occupies the first subchannel of S160 "
            "above ED threshold",
            {{dBm_t{-61}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{70}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{50}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "Reception of a 20 MHz signal that occupies the second subchannel of S160 "
            "above ED threshold",
            {{dBm_t{-61}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{50}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{30}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "Reception of a 20 MHz signal that occupies the third subchannel of S160 "
            "above ED threshold",
            {{dBm_t{-61}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{30}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "below ED threshold",
            {{dBm_t{-65}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "Reception of a 20 MHz signal that occupies the fourth subchannel of S160 "
            "above ED threshold",
            {{dBm_t{-61}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-60}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{20}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-58}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{20}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-60}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{60}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-58}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{60}, MHz_t{40}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-57}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{40}, MHz_t{80}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-55}, tx1Start, txDuration1, S160_CENTER_FREQUENCY - MHz_t{40}, MHz_t{80}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-54}, tx1Start, txDuration1, S160_CENTER_FREQUENCY, MHz_t{160}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-52}, tx1Start, txDuration1, S160_CENTER_FREQUENCY, MHz_t{160}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-51}, tx1Start, txDuration1, P320_CENTER_FREQUENCY, MHz_t{320}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            {{dBm_t{-49}, tx1Start, txDuration1, P320_CENTER_FREQUENCY, MHz_t{320}}},
            {},
            {
                {aCcaTimeWithDelta, WifiPhyState::CCA_BUSY}, // CCA-BUSY after aCcaTimeWithDelta
                {txEndSignal1 - smallDelta,
        ...
        ScheduleTest(
            ...
            "20 MHz signal that occupies P20",
            {{dBm_t{-52}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{70}, MHz_t{20}},
             {dBm_t{-52}, tx2Start, txDuration2, P20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(
            ...
            "that occupies S80",
            {{dBm_t{-52}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{50}, MHz_t{20}},
             {dBm_t{-52}, tx2Start, txDuration2, S80_CENTER_FREQUENCY - MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(
            ...
            "Reception of a signal that occupies S160 followed by the reception of another signal "
            "that occupies S40",
            {{dBm_t{-52}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{30}, MHz_t{20}},
             {dBm_t{-52}, tx2Start, txDuration2, S40_CENTER_FREQUENCY + MHz_t{10}, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(
            ...
            "Reception of a signal that occupies S160 followed by the reception of another signal "
            "that occupies S20",
            {{dBm_t{-52}, tx1Start, txDuration1, S160_CENTER_FREQUENCY + MHz_t{10}, MHz_t{20}},
             {dBm_t{-52}, tx2Start, txDuration2, S20_CENTER_FREQUENCY, MHz_t{20}}},
            {},
            {
                {aCcaTimeWithDelta,
                 WifiPhyState::IDLE}, // state of primary stays idle after aCcaTimeWithDelta
        ...
        ScheduleTest(
            ...
            {},
            {{dBm_t{-64}, tx1Start, S160_CENTER_FREQUENCY, MHz_t{160}}},
            {
                {aCcaTimeWithDelta, WifiPhyState::IDLE}, // IDLE after aCcaTimeWithDelta
                {ppduDurations.at(MHz_t{160}) - smallDelta,
                 WifiPhyState::IDLE}, // IDLE just before the transmission ends
                {ppduDurations.at(MHz_t{160}) + smallDelta,
                 WifiPhyState::IDLE} // IDLE just after the transmission ends
            },
    ...
    ScheduleTest(
          ...
          m_expectedPer20MhzCcaBusyDurations.at(1)}},
        {
            {.timePoint = thresholdUpdateTime,
             .ccaThreshold =
                 dBm_t{-50}}, // change CCA threshold during the reception to a higher value
        });
    delay += testStep;
    ResetExpectedPer20MhzCcaBusyDurations();
    ...
    ScheduleTest(
        ...
        },
        {
            {.timePoint = thresholdUpdateTime,
             .ccaThreshold =
                 dBm_t{-70}}, // change CCA threshold during the reception to a higher value
        });
    delay += testStep;
    ResetExpectedPer20MhzCcaBusyDurations();
