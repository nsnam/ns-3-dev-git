 ...
 * @{
 */
NS_DEPRECATED_3_45("Use WifiRcvAddr::UNICAST instead")
static constexpr auto WIFI_UNICAST = WifiRcvAddr::UNICAST;
NS_DEPRECATED_3_45("Use WifiRcvAddr::BROADCAST instead")
static constexpr auto WIFI_BROADCAST = WifiRcvAddr::BROADCAST;
NS_DEPRECATED_3_45("Use WifiRcvAddr::GROUPCAST instead")
