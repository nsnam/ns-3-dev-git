...
class YansErrorRateModel : public ErrorRateModel
{
  ...
  private:
     ...
     */
    double GetBpskBer(double snr, MHz_t signalSpread, uint64_t phyRate) const;
    /**
     ...
     * @return BER of BPSK at the given SNR
     */
    double GetQamBer(double snr, unsigned int m, MHz_t signalSpread, uint64_t phyRate) const;
    /**
     * Return k!
     *
     * @param k
