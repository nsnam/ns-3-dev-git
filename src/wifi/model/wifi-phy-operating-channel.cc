...
std::set<uint8_t>
WifiPhyOperatingChannel::Get20MHzIndicesCoveringRu(HeRu::RuSpec ru, MHz_t width) const
{
    ...
    if (ruType == RuType::RU_26_TONE && ru.GetIndex() == 19)
    {
        ...
        auto indices = ru.GetPrimary80MHz() ? GetAll20MHzChannelIndicesInPrimary(MHz_t{80})
    ...
    auto nRusInCoveringChannel = HeRu::GetNRus(n20MHzChannels * MHz_t{20}, ruType);
