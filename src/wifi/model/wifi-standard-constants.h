...
/// AID11 value for a Multi-STA BlockAck Per AID TID Info subfield intended for an unassociated STA
/// (Sec. 9.3.1.8.6 of 802.11-2024)
static constexpr uint16_t MULTISTA_BA_UNASSOC_STA_AID11{2045};
