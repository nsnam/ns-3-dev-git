...
class HePhy : public VhtPhy
{
  public:
     ...
     */
    std::vector<MHz_t> GetCenterFrequenciesForNonHePart(const Ptr<const WifiPpdu> ppdu,
    ...
    {
        MHz_t bandWidth; ///< width of the band used for the OFDMA transmission. Must be a multiple
                         ///< of 20 MHz
        MHz_t guardBandwidth;                        ///< width of the guard band
        const std::vector<MHz_t>& centerFrequencies; ///< center frequency of each segment
        MHz_t totalWidth;                            ///< width of the operating channel
        Hz_t subcarrierSpacing;                      ///< subcarrier spacing
