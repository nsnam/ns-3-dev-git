...
DynamicNeighborCacheTest::DynamicNeighborCacheTest ()
  : TestCase ("The DynamicNeighborCacheTestPopulate checks if neighbor caches are correctly populated in global scope and updated when there is an IP address added or removed.")
{}
...
DynamicNeighborCacheTest::SendData (Ptr<Socket> socket, Ipv4Address to)
{
  ...
  Simulator::ScheduleWithContext (socket->GetNode ()->GetId (), Seconds (60),
                                  &DynamicNeighborCacheTest::DoSendDatav4, this, socket, to);
}
...
DynamicNeighborCacheTest::SendData (Ptr<Socket> socket, Ipv6Address to)
{
  m_receivedPacket = Create<Packet> ();
  Simulator::ScheduleWithContext (socket->GetNode ()->GetId (), Seconds (60),
                                  &DynamicNeighborCacheTest::DoSendDatav6, this, socket, to);
}

void
DynamicNeighborCacheTest::AddIpv4Address (Ptr<Ipv4Interface> ipv4Interface, Ipv4InterfaceAddress ifaceAddr)
{
  ipv4Interface->AddAddress (ifaceAddr);
}

void
DynamicNeighborCacheTest::AddIpv6Address (Ptr<Ipv6Interface> ipv6Interface, Ipv6InterfaceAddress ifaceAddr)
{
...
DynamicNeighborCacheTest::DoRun (void)
{
  ...
  Simulator::Schedule (Seconds (0.5),&DynamicNeighborCacheTest::AddIpv4Address,this, ipv4Interface, ifaceAddr);

  // Remove the first address (10.1.1.3) from rxNode in 1.5 seconds
  uint32_t addressIndex = 0;
  Simulator::Schedule (Seconds (1.5),&DynamicNeighborCacheTest::RemoveIpv4Address,this, ipv4Interface, addressIndex);
  ...
  Ipv6InterfaceAddress ifaceAddrv6 = Ipv6InterfaceAddress ( "2001:0::200:ff:fe00:5", Ipv6Prefix (64));
  Simulator::Schedule (Seconds (0.5),&DynamicNeighborCacheTest::AddIpv6Address, this, ipv6Interface, ifaceAddrv6);

  // Remove the second address (2001:1::200:ff:fe00:3) from rxNode in 1.5 seconds
  addressIndex = 1;
  Simulator::Schedule (Seconds (1.5),&DynamicNeighborCacheTest::RemoveIpv6Address, this, ipv6Interface, addressIndex);
  ...
  NS_TEST_EXPECT_MSG_EQ (rxSocketv4->Bind (InetSocketAddress (Ipv4Address ("10.0.1.5"), 1234)), 0, "trivial");
  NS_TEST_EXPECT_MSG_EQ (rxSocketv6->Bind (Inet6SocketAddress (Ipv6Address ("2001:0::200:ff:fe00:5"), 1234)), 0, "trivial");
  ...
  NS_TEST_EXPECT_MSG_EQ (snifferSocketv4->Bind (InetSocketAddress (Ipv4Address ("10.0.1.4"), 1234)), 0, "trivial");
  NS_TEST_EXPECT_MSG_EQ (snifferSocketv6->Bind (Inet6SocketAddress (Ipv6Address ("2001:0::200:ff:fe00:4"), 1234)), 0, "trivial");
  ...
  NS_TEST_EXPECT_MSG_EQ (m_receivedPacketSizes[0], 123, "Should receive packet sending to the added IPv4 address.");
  NS_TEST_EXPECT_MSG_EQ (m_receivedPacketSizes[1], 123, "Should receive packet sending to the added IPv6 address.");
  NS_TEST_EXPECT_MSG_EQ (m_receivedPacketSizes.size (), 2, "Should receive only 1 packet from IPv4 interface and only 1 packet from IPv6 interface.");
...
ChannelTest::ChannelTest ()
  : TestCase ("The ChannelTest Check if neighbor caches are correctly populated on specific channel.")
{}
...
NetDeviceContainerTest::NetDeviceContainerTest ()
  : TestCase ("The NetDeviceContainerTest check if neighbor caches are populated correctly on specific netDeviceContainer.")
{}
...
InterfaceContainerTest::InterfaceContainerTest ()
  : TestCase ("The InterfaceContainerTest check if neighbor caches are populated correctly on specific interfaceContainer.")
{}
...
FlushTest::FlushTest ()
  : TestCase ("The FlushTest checks that FlushAutoGenerated() will only remove STATIC_AUTOGENERATED entries.")
{}
...
DuplicateTest::DuplicateTest ()
  : TestCase ("The DuplicateTest checks that populate neighbor caches in overlapped scope does not raise an error or generate duplicate entries.")
{}
...
DynamicPartialTest::DynamicPartialTest ()
  : TestCase ("The DynamicPartialTest checks if dynamic neighbor cache update correctly when generating on a non-global scope.")
{}
...
DynamicPartialTest::DoRun ()
{
  ...
  Simulator::Schedule (Seconds (0.5),&DynamicPartialTest::AddIpv4Address,this, ipv4Interface, ifaceAddr);

  // Remove the first address (10.1.1.1) from n1 in 1.5 seconds
  uint32_t addressIndex = 0;
  Simulator::Schedule (Seconds (1.5),&DynamicPartialTest::RemoveIpv4Address,this, ipv4Interface, addressIndex);
  ...
  Ptr<Ipv6Interface> ipv6Interface = n1->GetObject<Ipv6L3Protocol> ()->GetInterface (ipv6ifIndex);
  Ipv6InterfaceAddress ifaceAddrv6 = Ipv6InterfaceAddress ( "2001:0::200:ff:fe00:5", Ipv6Prefix (64));
  Simulator::Schedule (Seconds (0.5),&DynamicPartialTest::AddIpv6Address, this, ipv6Interface, ifaceAddrv6);

  // Remove the second address (2001:1::200:ff:fe00:1) from n1 in 1.5 seconds
  addressIndex = 1;
  Simulator::Schedule (Seconds (1.5),&DynamicPartialTest::RemoveIpv6Address, this, ipv6Interface, addressIndex);
