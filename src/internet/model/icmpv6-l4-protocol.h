...
public:
   ...
   */
  NdiscCache::PacketWithHeader ForgeNS (Ipv6Address src, Ipv6Address dst, Ipv6Address target, Address hardwareAddress);
   ...
   */
  NdiscCache::PacketWithHeader ForgeNA (Ipv6Address src, Ipv6Address dst, Address* hardwareAddress, uint8_t flags);
   ...
   */
  NdiscCache::PacketWithHeader ForgeRS (Ipv6Address src, Ipv6Address dst, Address hardwareAddress);
   ...
   */
  NdiscCache::PacketWithHeader ForgeEchoRequest (Ipv6Address src, Ipv6Address dst, uint16_t id, uint16_t seq, Ptr<Packet> data);
