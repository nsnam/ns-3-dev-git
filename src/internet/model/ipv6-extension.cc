...
void Ipv6ExtensionFragment::GetFragments (Ptr<Packet> packet, Ipv6Header ipv6Header, uint32_t maxFragmentSize, std::list<PacketWithHeader>& listFragments)
{
  Ptr<Packet> p = packet->Copy ();
  ...
  do
    {
      ...
      listFragments.push_back (PacketWithHeader (fragment, ipv6Header));
    }
  while (moreFragment);
