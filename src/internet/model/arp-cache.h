...
public:
     ...
     * \param waiting
     */
    void MarkWaitReply (PacketWithHeader waiting);
    /**
     ...
     * \return 
     */
    bool UpdateWaitReply (PacketWithHeader waiting);
    /**
     ...
     *            packets are pending.
     */
    PacketWithHeader DequeuePending (void);
    /**
...
private:
    ...
    std::list<PacketWithHeader> m_pending; //!< list of pending packets for the entry's IP
