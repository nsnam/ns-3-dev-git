...
class ArpCache : public Object
{
  public:
    ...
    /**
     * @brief Clear the ArpCache of all entries, except the ones marked as permanent or
     * autogenerated
     */
    void Flush();

    /**
     * @brief Clear the ArpCache of all entries, including the ones marked as permanent or
     * autogenerated
     */
    void FlushAll();
  ...
  private:
     ...
     * @param force whether to flush all entries, including the permanent and autogenerated ones
     */
