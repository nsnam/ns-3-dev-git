...
void
Gnuplot::SetOutputFilename(const std::string& outputFilename)
{
    m_outputFilename = outputFilename;
}

std::string
Gnuplot::DetectTerminal(const std::string& filename)
{
...
void
GnuplotCollection::GenerateOutput(std::ostream& osControl,
                                  std::ostream& osData,
