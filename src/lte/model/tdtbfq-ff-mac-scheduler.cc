...
TypeId
TdTbfqFfMacScheduler::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TdTbfqFfMacScheduler")
...
void
TdTbfqFfMacScheduler::DoCschedCellConfigReq(
...
void
TdTbfqFfMacScheduler::DoCschedUeConfigReq(
...
void
TdTbfqFfMacScheduler::DoCschedLcConfigReq(
    ...
    for (std::size_t i = 0; i < params.m_logicalChannelConfigList.size(); i++)
    {
        ...
        if (it == m_flowStatsDl.end())
        {
            ...
            m_flowStatsDl.insert(
                std::pair<uint16_t, tdtbfqsFlowPerf_t>(params.m_rnti, flowStatsDl));
            ...
            m_flowStatsUl.insert(
                std::pair<uint16_t, tdtbfqsFlowPerf_t>(params.m_rnti, flowStatsUl));
        }
        else
        {
...
void
TdTbfqFfMacScheduler::DoCschedLcReleaseReq(
...
void
TdTbfqFfMacScheduler::DoCschedUeReleaseReq(
...
void
TdTbfqFfMacScheduler::DoSchedDlRlcBufferReq(
...
void
TdTbfqFfMacScheduler::DoSchedDlPagingBufferReq(
...
void
TdTbfqFfMacScheduler::DoSchedDlMacBufferReq(
...
void
TdTbfqFfMacScheduler::DoSchedDlTriggerReq(
    const FfMacSchedSapProvider::SchedDlTriggerReqParameters& params)
{
    ...
    {
        // all UEs are allocated RBG or all UEs already allocated for HARQ or without HARQ process
        // available
        return;
    }
    else
    {
        ...
        for (int i = 0; i < rbgNum; i++)
        {
            ...
            if (!m_ffrSapProvider->IsDlRbgAvailableForUe(i, (*itMax).first))
            {
                continue;
            }
...
void
TdTbfqFfMacScheduler::DoSchedDlRachInfoReq(
...
void
TdTbfqFfMacScheduler::DoSchedDlCqiInfoReq(
...
void
TdTbfqFfMacScheduler::DoSchedUlTriggerReq(
...
void
TdTbfqFfMacScheduler::DoSchedUlNoiseInterferenceReq(
...
void
TdTbfqFfMacScheduler::DoSchedUlSrInfoReq(
...
void
TdTbfqFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void
TdTbfqFfMacScheduler::DoSchedUlCqiInfoReq(
...
void
TdTbfqFfMacScheduler::RefreshDlCqiMaps()
{
...
void
TdTbfqFfMacScheduler::RefreshUlCqiMaps()
{
    // refresh UL CQI  Map
