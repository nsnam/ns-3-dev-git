...
TypeId
TdBetFfMacScheduler::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::TdBetFfMacScheduler")
...
void
TdBetFfMacScheduler::DoCschedCellConfigReq(
...
void
TdBetFfMacScheduler::DoCschedUeConfigReq(
...
void
TdBetFfMacScheduler::DoCschedLcConfigReq(
...
void
TdBetFfMacScheduler::DoCschedLcReleaseReq(
...
void
TdBetFfMacScheduler::DoCschedUeReleaseReq(
...
void
TdBetFfMacScheduler::DoSchedDlRlcBufferReq(
...
void
TdBetFfMacScheduler::DoSchedDlPagingBufferReq(
...
void
TdBetFfMacScheduler::DoSchedDlMacBufferReq(
...
void
TdBetFfMacScheduler::DoSchedDlTriggerReq(
...
void
TdBetFfMacScheduler::DoSchedDlRachInfoReq(
...
void
TdBetFfMacScheduler::DoSchedDlCqiInfoReq(
...
void
TdBetFfMacScheduler::DoSchedUlTriggerReq(
...
void
TdBetFfMacScheduler::DoSchedUlNoiseInterferenceReq(
...
void
TdBetFfMacScheduler::DoSchedUlSrInfoReq(
...
void
TdBetFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void
TdBetFfMacScheduler::DoSchedUlCqiInfoReq(
...
void
TdBetFfMacScheduler::RefreshDlCqiMaps()
{
...
void
TdBetFfMacScheduler::RefreshUlCqiMaps()
{
    // refresh UL CQI  Map
