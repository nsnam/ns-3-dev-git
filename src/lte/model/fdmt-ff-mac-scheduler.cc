...
TypeId
FdMtFfMacScheduler::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::FdMtFfMacScheduler")
...
void
FdMtFfMacScheduler::DoCschedCellConfigReq(
...
void
FdMtFfMacScheduler::DoCschedUeConfigReq(
...
void
FdMtFfMacScheduler::DoCschedLcConfigReq(
...
void
FdMtFfMacScheduler::DoCschedLcReleaseReq(
...
void
FdMtFfMacScheduler::DoCschedUeReleaseReq(
...
void
FdMtFfMacScheduler::DoSchedDlRlcBufferReq(
...
void
FdMtFfMacScheduler::DoSchedDlPagingBufferReq(
...
void
FdMtFfMacScheduler::DoSchedDlMacBufferReq(
...
void
FdMtFfMacScheduler::DoSchedDlRachInfoReq(
...
void
FdMtFfMacScheduler::DoSchedDlCqiInfoReq(
...
void
FdMtFfMacScheduler::DoSchedUlTriggerReq(
...
void
FdMtFfMacScheduler::DoSchedUlNoiseInterferenceReq(
...
void
FdMtFfMacScheduler::DoSchedUlSrInfoReq(
...
void
FdMtFfMacScheduler::DoSchedUlMacCtrlInfoReq(
...
void
FdMtFfMacScheduler::DoSchedUlCqiInfoReq(
...
void
FdMtFfMacScheduler::RefreshDlCqiMaps()
{
...
void
FdMtFfMacScheduler::RefreshUlCqiMaps()
{
    // refresh UL CQI  Map
