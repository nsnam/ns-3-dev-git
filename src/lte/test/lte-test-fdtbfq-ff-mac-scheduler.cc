...
LenaTestFdTbfqFfMacSchedulerSuite::LenaTestFdTbfqFfMacSchedulerSuite()
    : TestSuite("lte-fdtbfq-ff-mac-scheduler", Type::SYSTEM)
{
    ...
    // Maximum throughput = 4 / ( 1/2196000 + 1/1191000 + 1/1383000 + 1/775000 ) = 1209046 byte/s
    // 232000 * 4 = 1328000 > 1209046 -> estimated throughput in downlink = 1209046 / 4 = 302266
    // byte/sec
...
LenaFdTbfqFfMacSchedulerTestCase2::DoRun()
{
    ...
    {
        NS_TEST_ASSERT_MSG_EQ_TOL((double)dlDataRxed.at(i) / statsDuration,
                                  m_estThrFdTbfqDl.at(i),
                                  m_estThrFdTbfqDl.at(i) * tolerance,
                                  " Unfair Throughput!");
    }
