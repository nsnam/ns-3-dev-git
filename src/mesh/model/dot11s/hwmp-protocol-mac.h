...
class HwmpProtocolMac : public MeshWifiInterfaceMacPlugin
{
  ...
  private:
    ...
    /// Sends one PREQ when PreqMinInterval after last PREQ expires (if any PREQ exists in rhe
    /// queue)
    void SendMyPreq();
    /// Send PERR function
    void SendMyPerr();
