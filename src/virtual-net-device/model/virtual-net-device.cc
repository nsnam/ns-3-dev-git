    ...
    static TypeId tid =
        TypeId("ns3::VirtualNetDevice")
            ...
            .AddAttribute(
                ...
                UintegerValue(1500),
                MakeUintegerAccessor(&VirtualNetDevice::SetMtu, &VirtualNetDevice::GetMtu),
...
bool
VirtualNetDevice::Receive(Ptr<Packet> packet,
                          uint16_t protocol,
...
bool
VirtualNetDevice::SendFrom(Ptr<Packet> packet,
                           const Address& source,
                           const Address& dest,
...
bool
VirtualNetDevice::IsBridge() const
{
    return false;
}
