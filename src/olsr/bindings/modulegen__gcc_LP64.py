...
def register_Ns3OlsrHelper_methods(root_module, cls):
    ...
    cls.add_constructor([])
    ## olsr-helper.h (module 'olsr'): ns3::OlsrHelper::OlsrHelper(ns3::OlsrHelper const & o) [constructor]
    cls.add_constructor([param('ns3::OlsrHelper const &', 'o')])
...
def register_Ns3OlsrRoutingProtocol_methods(root_module, cls):
    ...
    cls.add_method('GetIpv4', 
                   'ns3::Ptr< ns3::Ipv4 >', 
                   [], 
                   deprecated=True, is_const=True, is_virtual=True)
