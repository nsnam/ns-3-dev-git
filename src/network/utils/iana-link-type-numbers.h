...
namespace iana
{
namespace linktype // Helper namespace to avoid using scoped enums
{
...
constexpr uint16_t IEEE802_11_RADIOTAP = 127;  //!< Radiotap header, followed by an 802.11 header.
