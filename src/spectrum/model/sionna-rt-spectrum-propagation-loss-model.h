...
#ifndef SIONNA_RT_SPECTRUM_PROPAGATION_LOSS_H
#define SIONNA_RT_SPECTRUM_PROPAGATION_LOSS_H
 ...
 */
class SionnaRtSpectrumPropagationLossModel : public PhasedArraySpectrumPropagationLossModel
{
  ...
  public:
     ...
     * Destructor
     */
    ~SionnaRtSpectrumPropagationLossModel() override;
     ...
     * @param configs the configuration structure
     */
  ...
  protected:
     ...
     * @param sW the beamforming vector of the first antenna
     * @param uW the beamforming vector of the second antenna
...
#endif /* SIONNA_RT_SPECTRUM_PROPAGATION_LOSS_H */
