...
public:
   ...
   * \param lowestPointDbr maximum relative power of the outermost subcarriers of the guard band (in dBr)
   * \param puncturedSubBands vector of start and stop subcarrier indexes of the punctured sub bands
   * \param puncturedSlopeWidth size (in number of subcarriers) of the punctured band slope
   */
  static void CreateSpectrumMaskForOfdm (Ptr<SpectrumValue> c, const std::vector<WifiSpectrumBand>& allocatedSubBands,
