...
class ThreeGppChannelModel : public MatrixBasedChannelModel
{
  ...
  protected:
     ...
     */
    bool NewChannelParamsNeeded(Ptr<const ThreeGppChannelParams> channelParams,
                                Ptr<const ChannelCondition> channelCondition) const;
     ...
     * @param channelMatrix Existing channel matrix that may need updating
     ...
     */
    bool NewChannelMatrixNeeded(Ptr<const ThreeGppChannelParams> channelParams,
