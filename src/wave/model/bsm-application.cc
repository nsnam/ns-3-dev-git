...
// Application Methods
void
BsmApplication::StartApplication() // Called at time specified by Start
{
    NS_LOG_FUNCTION(this);
...
void
BsmApplication::StopApplication() // Called at time specified by Stop
{
    NS_LOG_FUNCTION(this);
}
...
void
BsmApplication::GenerateWaveTraffic(Ptr<Socket> socket,
                                    uint32_t pktSize,
                                    uint32_t pktCount,
                                    Time pktInterval,
...
void
BsmApplication::ReceiveWavePacket(Ptr<Socket> socket)
{
    NS_LOG_FUNCTION(this);
...
void
BsmApplication::HandleReceivedBsmPacket(Ptr<Node> txNode, Ptr<Node> rxNode)
{
    NS_LOG_FUNCTION(this);
