  ...
  const AttributeDescriptor attributes [] =
    {
      ...
      { "dB",             "dB",             true,  "units-power.h"      },
      { "dBr",            "dBr",            true,  "units-power.h"      },
      { "dBm",            "dBm",            true,  "units-power.h"      },
      { "dBm_per_Hz",     "dBm_per_Hz",     true,  "units-power.h"      },
      { "dBm_per_MHz",    "dBm_per_MHz",    true,  "units-power.h"      },
