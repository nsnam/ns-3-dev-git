...
{
    std::ofstream fPlotQueue("n0.csv", std::ios::out | std::ios::app);
    fPlotQueue << Simulator::Now().GetSeconds() << "," << newCwnd << std::endl;
    fPlotQueue.close();
}
...
main(int argc, char* argv[])
{
    ...
    pointToPointLeaf.EnablePcapAll("pcap_ns-3", true);
