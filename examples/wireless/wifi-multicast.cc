...
main(int argc, char* argv[])
{
    ...
    cmd.AddValue("accessCategory",
                 "select the multicast traffic access category (BE, BK, VI, VO)",
                 accessCategory);
    cmd.AddValue(
    ...
    const auto maxAmpduSizeAttribute = accessCategory + "_MaxAmpduSize";
    ...
    // source
    const auto tosValue = acToTos.at(accessCategory);
