...
cpp_examples = [
    ...
    (
        "wifi-ht-network --multiProcessing=1 --simulationTime=0.2s --frequency=5GHz --useRts=0 --minExpectedThroughput=5Mbps --maxExpectedThroughput=135Mbps",
        "True",
        "True",
    ),
    (
        "wifi-ht-network --multiProcessing=1 --simulationTime=0.2s --frequency=5GHz --useRts=1 --minExpectedThroughput=5Mbps --maxExpectedThroughput=132Mbps",
        "True",
        "True",
    ),
    (
        "wifi-ht-network --multiProcessing=1 --simulationTime=0.2s --frequency=2.4GHz --useRts=0 --minExpectedThroughput=5Mbps --maxExpectedThroughput=132Mbps",
        "True",
        "True",
    ),
    (
        "wifi-ht-network --multiProcessing=1 --simulationTime=0.2s --frequency=2.4GHz --useRts=1 --minExpectedThroughput=5Mbps --maxExpectedThroughput=129Mbps",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-he-network --multiProcessing=1 --simulationTime=0.25s --frequency=5GHz --useRts=0 --use80Plus80=1 --minExpectedThroughput=6Mbps --maxExpectedThroughput=844Mbps",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-he-network --multiProcessing=1 --simulationTime=0.3s --udp=0 --downlink=1 --useRts=0 --nStations=4 --dlAckType=ACK-SU-FORMAT --enableUlOfdma=1 --enableBsrp=0 --mcs=4 --minExpectedThroughput=20Mbps --maxExpectedThroughput=212Mbps",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-he-network --multiProcessing=1 --simulationTime=0.3s --udp=0 --downlink=1 --useRts=0 --nStations=5 --dlAckType=AGGR-MU-BAR --enableUlOfdma=1 --enableBsrp=0 --mcs=6 --muSchedAccessReqInterval=50ms --minExpectedThroughput=31Mbps --maxExpectedThroughput=290Mbps",
        "True",
        "True",
    ),
    (
        "wifi-he-network --multiProcessing=1 --simulationTime=0.3s --udp=1 --downlink=0 --useRts=1 --nStations=5 --dlAckType=AGGR-MU-BAR --enableUlOfdma=1 --enableBsrp=1 --mcs=5 --muSchedAccessReqInterval=50ms --minExpectedThroughput=46Mbps --maxExpectedThroughput=327Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=5GHz --useRts=0 --minExpectedThroughput=6Mbps --maxExpectedThroughput=760Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=5GHz --useRts=0 --use80Plus80=1 --minExpectedThroughput=6Mbps --maxExpectedThroughput=760Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=5GHz --useRts=0 --mpduBufferSize=1024 --frequency2=6GHz --minExpectedThroughput=7Mbps --maxExpectedThroughput=1444Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=6GHz --useRts=1 --minExpectedThroughput=5Mbps --maxExpectedThroughput=800Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=2.4GHz --useRts=0 --mpduBufferSize=512 --frequency2=5GHz --minExpectedThroughput=7Mbps --maxExpectedThroughput=512Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.1s --frequency=2.4GHz --useRts=1 --minExpectedThroughput=5Mbps --maxExpectedThroughput=240Mbps",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.25s --frequency=2.4GHz --udp=0 --downlink=1 --useRts=0 --nStations=5 --dlAckType=MU-BAR --enableUlOfdma=1 --enableBsrp=1 --mcs=5 --frequency2=5GHz --mpduBufferSize=1024 --minExpectedThroughput=50Mbps --maxExpectedThroughput=120Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.3s --udp=0 --downlink=1 --useRts=1 --nStations=5 --dlAckType=AGGR-MU-BAR --enableUlOfdma=1 --enableBsrp=0 --mcs=6 --muSchedAccessReqInterval=50ms --frequency2=2.4GHz --minExpectedThroughput=50Mbps --maxExpectedThroughput=140Mbps",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.25s --udp=0 --downlink=0 --useRts=0 --nStations=4 --dlAckType=AGGR-MU-BAR --enableUlOfdma=1 --enableBsrp=1 --mpduBufferSize=1024 --mcs=8 --muSchedAccessReqInterval=45ms --frequency2=6GHz --minExpectedThroughput=50Mbps --maxExpectedThroughput=550Mbps --RngRun=7",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.2s --frequency=2.4GHz --frequency2=5GHz --guardInterval=1600ns --udp=0 --downlink=1 --useRts=0 --mpduBufferSize=512 --emlsrLinks=0,1 --emlsrPaddingDelay=32us --emlsrTransitionDelay=32us --channelSwitchDelay=32us --emlsrAuxSwitch=True --emlsrAuxTxCapable=True --minExpectedThroughput=3Mbps --maxExpectedThroughput=200Mbps --RngRun=2",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.3s --frequency=2.4GHz --frequency2=5GHz --frequency3=6GHz --guardInterval=1600ns --udp=0 --downlink=0 --useRts=1 --mpduBufferSize=512 --emlsrLinks=0,1,2 --emlsrPaddingDelay=64us --emlsrTransitionDelay=64us --channelSwitchDelay=64us --emlsrAuxSwitch=False --emlsrAuxTxCapable=True --nStations=4 --dlAckType=MU-BAR --enableUlOfdma=1 --enableBsrp=1 --mcs=1,4,8,11,13 --minExpectedThroughput=10Mbps --maxExpectedThroughput=300Mbps --RngRun=4",
        "True",
        "True",
    ),
    (
        "wifi-eht-network --multiProcessing=1 --simulationTime=0.3s --frequency=2.4GHz --frequency2=5GHz --frequency3=6GHz --guardInterval=1600ns --udp=0 --downlink=0 --useRts=1 --mpduBufferSize=512 --emlsrLinks=0,1,2 --emlsrPaddingDelay=0us --emlsrTransitionDelay=0us --channelSwitchDelay=1ns --emlsrMgrTypeId=ns3::AdvancedEmlsrManager --emlsrAuxSwitch=False --emlsrAuxTxCapable=False --nStations=4 --dlAckType=ACK-SU-FORMAT --enableUlOfdma=1 --enableBsrp=1 --mcs=1,5,8,11 --minExpectedThroughput=8Mbps --maxExpectedThroughput=288Mbps --RngRun=5",
        "True",
        "True",
    ),
    (
        "wifi-simple-ht-hidden-stations --simulationTime=1s --enableRts=0 --nMpdus=32 --minExpectedThroughput=59Mbps --maxExpectedThroughput=60Mbps",
        "True",
        "True",
    ),
    (
        "wifi-simple-ht-hidden-stations --simulationTime=1s --enableRts=1 --nMpdus=32 --minExpectedThroughput=57Mbps --maxExpectedThroughput=58Mbps",
        "True",
        "True",
    ),
    ...
    (
        "wifi-multicast --gcrRetransmissionPolicy=GcrUr --maxAmpduLength=65535 --maxPackets=0 --nStations=4 --dataRate=50Mbps --gcrProtection=Rts-Cts --rtsThreshold=0 --simulationTime=1 --minExpectedThroughput=35Mbps --maxExpectedThroughput=40Mbps",
        "True",
        "True",
    ),
    (
        "wifi-multicast --gcrRetransmissionPolicy=GcrUr --maxAmpduLength=65535 --maxPackets=0 --nStations=4 --dataRate=50Mbps --gcrProtection=Cts-To-Self --simulationTime=1 --minExpectedThroughput=40Mbps --maxExpectedThroughput=45Mbps",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-multicast --gcrRetransmissionPolicy=GcrBlockAck --maxAmpduLength=65535 --maxPackets=0 --nStations=4 --dataRate=100Mbps --gcrProtection=Rts-Cts --rtsThreshold=0 --simulationTime=1s --minExpectedThroughput=100Mbps --maxExpectedThroughput=100Mbps",
        "True",
        "True",
    ),
    (
        "wifi-multicast --gcrRetransmissionPolicy=GcrBlockAck --maxAmpduLength=65535 --maxPackets=0 --nStations=4 --dataRate=100Mbps --gcrProtection=Cts-To-Self --simulationTime=1s --minExpectedThroughput=100Mbps --maxExpectedThroughput=100Mbps",
        "True",
        "True",
    ),
    (
        "wifi-p2p --simulationTime=1s --adhocToStaMinExpectedThroughput=49Mbps --staToAdhocMinExpectedThroughput=49Mbps --staToAdhocMaxExpectedLoss=1.0 --adhocToStaMaxExpectedLoss=1.0",
        "True",
        "True",
    ),
    (
    ...
    (
        "wifi-p2p --simulationTime=1s --numLinksAp=2 --numLinksSta=2 --numLinksP2p=1 --adhocToStaMinExpectedThroughput=49Mbps --staToAdhocMinExpectedThroughput=49Mbps --staToAdhocMaxExpectedLoss=1.0 --adhocToStaMaxExpectedLoss=1.0",
        "True",
        "True",
    ),
    (
        "wifi-p2p --simulationTime=1s --numLinksAp=2 --numLinksSta=3 --numLinksP2p=1 --linksOverlap=0 --adhocToStaMinExpectedThroughput=49Mbps --staToAdhocMinExpectedThroughput=49Mbps --staToAdhocMaxExpectedLoss=1.0 --adhocToStaMaxExpectedLoss=1.0",
        "True",
        "True",
    ),
    (
